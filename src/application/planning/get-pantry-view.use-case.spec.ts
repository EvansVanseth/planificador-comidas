...
import { GetPantryViewUseCase } from './get-pantry-view.use-case';
...
describe('GetPantryViewUseCase', () => {
  ...
  let useCase: GetPantryViewUseCase;
  ...
  beforeEach(() => {
    ...
    useCase = new GetPantryViewUseCase(
