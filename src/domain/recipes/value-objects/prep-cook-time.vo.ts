...
export class PrepCookTime {
  readonly value: number;
  static readonly MIN_VALUE = 1;
  private static readonly FIELD_NAME = 'tiempo de preparacion';

  private constructor(value: number) {
    this.value = value;
  }

  public static create(value: number): PrepCookTime {
