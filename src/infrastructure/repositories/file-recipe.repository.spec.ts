...
describe('FileRecipeRepository', () => {
  ...
  it('debe actualizar una receta existente al guardar con el mismo id', async () => {
    const recipe = Recipe.create(validId, userId, 'Pasta', 2, 20, null, [], defaultTags);
    await repo.save(recipe);
  ...
  it('debe filtrar recetas por userId', async () => {
    const r1 = Recipe.create(validId, userId, 'Pasta', 2, 20, null, [], defaultTags);
  ...
  it('debe preservar ingredientes y tags tras guardar y recuperar', async () => {
